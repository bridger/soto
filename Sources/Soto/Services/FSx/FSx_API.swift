...
public struct FSx: AWSService {
    ...
    public init(
        ...
        self.config = AWSServiceConfig(
            ...
            endpoint: endpoint,
            serviceEndpoints: [
                "fips-ca-central-1": "fsx-fips.ca-central-1.amazonaws.com",
                "fips-prod-ca-central-1": "fsx-fips.ca-central-1.amazonaws.com",
                "fips-prod-us-east-1": "fsx-fips.us-east-1.amazonaws.com",
                "fips-prod-us-east-2": "fsx-fips.us-east-2.amazonaws.com",
                "fips-prod-us-gov-east-1": "fsx-fips.us-gov-east-1.amazonaws.com",
                "fips-prod-us-gov-west-1": "fsx-fips.us-gov-west-1.amazonaws.com",
                "fips-prod-us-west-1": "fsx-fips.us-west-1.amazonaws.com",
                "fips-prod-us-west-2": "fsx-fips.us-west-2.amazonaws.com",
                "fips-us-east-1": "fsx-fips.us-east-1.amazonaws.com",
                "fips-us-east-2": "fsx-fips.us-east-2.amazonaws.com",
                "fips-us-gov-east-1": "fsx-fips.us-gov-east-1.amazonaws.com",
                "fips-us-gov-west-1": "fsx-fips.us-gov-west-1.amazonaws.com",
                "fips-us-west-1": "fsx-fips.us-west-1.amazonaws.com",
                "fips-us-west-2": "fsx-fips.us-west-2.amazonaws.com"
            ],
    ...
    public func createDataRepositoryAssociation(_ input: CreateDataRepositoryAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDataRepositoryAssociationResponse> {
        return self.client.execute(operation: "CreateDataRepositoryAssociation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createFileCache(_ input: CreateFileCacheRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFileCacheResponse> {
        return self.client.execute(operation: "CreateFileCache", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createStorageVirtualMachine(_ input: CreateStorageVirtualMachineRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateStorageVirtualMachineResponse> {
        return self.client.execute(operation: "CreateStorageVirtualMachine", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Creates an FSx for ONTAP or Amazon FSx for OpenZFS storage volume.
    public func createVolume(_ input: CreateVolumeRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateVolumeResponse> {
    ...
    public func createVolumeFromBackup(_ input: CreateVolumeFromBackupRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateVolumeFromBackupResponse> {
        return self.client.execute(operation: "CreateVolumeFromBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDataRepositoryAssociation(_ input: DeleteDataRepositoryAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDataRepositoryAssociationResponse> {
        return self.client.execute(operation: "DeleteDataRepositoryAssociation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteFileCache(_ input: DeleteFileCacheRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteFileCacheResponse> {
        return self.client.execute(operation: "DeleteFileCache", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteStorageVirtualMachine(_ input: DeleteStorageVirtualMachineRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteStorageVirtualMachineResponse> {
        return self.client.execute(operation: "DeleteStorageVirtualMachine", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Deletes an Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS volume.
    public func deleteVolume(_ input: DeleteVolumeRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteVolumeResponse> {
    ...
    public func describeDataRepositoryAssociations(_ input: DescribeDataRepositoryAssociationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDataRepositoryAssociationsResponse> {
        return self.client.execute(operation: "DescribeDataRepositoryAssociations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeFileCaches(_ input: DescribeFileCachesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFileCachesResponse> {
        return self.client.execute(operation: "DescribeFileCaches", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeStorageVirtualMachines(_ input: DescribeStorageVirtualMachinesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStorageVirtualMachinesResponse> {
        return self.client.execute(operation: "DescribeStorageVirtualMachines", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Describes one or more Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS volumes.
    public func describeVolumes(_ input: DescribeVolumesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeVolumesResponse> {
    ...
    public func releaseFileSystemNfsV3Locks(_ input: ReleaseFileSystemNfsV3LocksRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReleaseFileSystemNfsV3LocksResponse> {
        return self.client.execute(operation: "ReleaseFileSystemNfsV3Locks", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Returns an Amazon FSx for OpenZFS volume to the state saved by the specified snapshot.
    public func restoreVolumeFromSnapshot(_ input: RestoreVolumeFromSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreVolumeFromSnapshotResponse> {
        return self.client.execute(operation: "RestoreVolumeFromSnapshot", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateDataRepositoryAssociation(_ input: UpdateDataRepositoryAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDataRepositoryAssociationResponse> {
        return self.client.execute(operation: "UpdateDataRepositoryAssociation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Updates the configuration of an existing Amazon File Cache resource. You can update multiple properties in a single request.
    public func updateFileCache(_ input: UpdateFileCacheRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFileCacheResponse> {
        return self.client.execute(operation: "UpdateFileCache", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateStorageVirtualMachine(_ input: UpdateStorageVirtualMachineRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateStorageVirtualMachineResponse> {
        return self.client.execute(operation: "UpdateStorageVirtualMachine", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Updates the configuration of an Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS volume.
    public func updateVolume(_ input: UpdateVolumeRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateVolumeResponse> {
