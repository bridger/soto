...
public struct S3: AWSService {
    ...
    public init(
        ...
        self.config = AWSServiceConfig(
            ...
            serviceEndpoints: [
                ...
                "fips-ca-central-1": "s3-fips.ca-central-1.amazonaws.com",
                "fips-us-east-1": "s3-fips.us-east-1.amazonaws.com",
                "fips-us-east-2": "s3-fips.us-east-2.amazonaws.com",
                "fips-us-gov-east-1": "s3-fips.us-gov-east-1.amazonaws.com",
                "fips-us-gov-west-1": "s3-fips.us-gov-west-1.amazonaws.com",
                "fips-us-west-1": "s3-fips.us-west-1.amazonaws.com",
                "fips-us-west-2": "s3-fips.us-west-2.amazonaws.com",
    ...
    public func abortMultipartUpload(_ input: AbortMultipartUploadRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AbortMultipartUploadOutput> {
        return self.client.execute(operation: "AbortMultipartUpload", path: "/{Bucket}/{Key+}?x-id=AbortMultipartUpload", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to CompleteMultipartUpload:    CreateMultipartUpload     UploadPart     AbortMultipartUpload     ListParts     ListMultipartUploads
    public func completeMultipartUpload(_ input: CompleteMultipartUploadRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CompleteMultipartUploadOutput> {
        return self.client.execute(operation: "CompleteMultipartUpload", path: "/{Bucket}/{Key+}?x-id=CompleteMultipartUpload", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///
    ///  The following operations are related to CreateMultipartUpload:    UploadPart     CompleteMultipartUpload     AbortMultipartUpload     ListParts     ListMultipartUploads
    public func createMultipartUpload(_ input: CreateMultipartUploadRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateMultipartUploadOutput> {
        return self.client.execute(operation: "CreateMultipartUpload", path: "/{Bucket}/{Key+}?uploads&x-id=CreateMultipartUpload", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBucket(_ input: DeleteBucketRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucket", path: "/{Bucket}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to DeleteBucketAnalyticsConfiguration:    GetBucketAnalyticsConfiguration     ListBucketAnalyticsConfigurations     PutBucketAnalyticsConfiguration
    @discardableResult public func deleteBucketAnalyticsConfiguration(_ input: DeleteBucketAnalyticsConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketAnalyticsConfiguration", path: "/{Bucket}?analytics", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBucketCors(_ input: DeleteBucketCorsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketCors", path: "/{Bucket}?cors", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBucketEncryption(_ input: DeleteBucketEncryptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketEncryption", path: "/{Bucket}?encryption", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBucketIntelligentTieringConfiguration(_ input: DeleteBucketIntelligentTieringConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketIntelligentTieringConfiguration", path: "/{Bucket}?intelligent-tiering", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBucketInventoryConfiguration(_ input: DeleteBucketInventoryConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketInventoryConfiguration", path: "/{Bucket}?inventory", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  For more information about the object expiration, see Elements to Describe Lifecycle Actions. Related actions include:    PutBucketLifecycleConfiguration     GetBucketLifecycleConfiguration
    @discardableResult public func deleteBucketLifecycle(_ input: DeleteBucketLifecycleRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketLifecycle", path: "/{Bucket}?lifecycle", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Deletes a metrics configuration for the Amazon CloudWatch request metrics (specified by the metrics configuration ID) from the bucket. Note that this doesn't include the daily storage metrics.
    ///  To use this operation, you must have permissions to perform the s3:PutMetricsConfiguration action. The bucket owner has this permission by default. The bucket owner can grant this permission to others. For more information about permissions, see Permissions Related to Bucket Subresource Operations and Managing Access Permissions to Your Amazon S3 Resources.
    ///  For information about CloudWatch request metrics for Amazon S3, see Monitoring Metrics with Amazon CloudWatch.  The following operations are related to DeleteBucketMetricsConfiguration:    GetBucketMetricsConfiguration     PutBucketMetricsConfiguration     ListBucketMetricsConfigurations     Monitoring Metrics with Amazon CloudWatch
    @discardableResult public func deleteBucketMetricsConfiguration(_ input: DeleteBucketMetricsConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketMetricsConfiguration", path: "/{Bucket}?metrics", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBucketOwnershipControls(_ input: DeleteBucketOwnershipControlsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketOwnershipControls", path: "/{Bucket}?ownershipControls", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  For more information about bucket policies, see Using Bucket Policies and UserPolicies.  The following operations are related to DeleteBucketPolicy     CreateBucket     DeleteObject
    @discardableResult public func deleteBucketPolicy(_ input: DeleteBucketPolicyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketPolicy", path: "/{Bucket}?policy", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to DeleteBucketReplication:    PutBucketReplication     GetBucketReplication
    @discardableResult public func deleteBucketReplication(_ input: DeleteBucketReplicationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketReplication", path: "/{Bucket}?replication", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Deletes the tags from the bucket.
    ///  To use this operation, you must have permission to perform the s3:PutBucketTagging action. By default, the bucket owner has this permission and can grant this permission to others.  The following operations are related to DeleteBucketTagging:    GetBucketTagging     PutBucketTagging
    @discardableResult public func deleteBucketTagging(_ input: DeleteBucketTaggingRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketTagging", path: "/{Bucket}?tagging", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to DeleteBucketWebsite:    GetBucketWebsite     PutBucketWebsite
    @discardableResult public func deleteBucketWebsite(_ input: DeleteBucketWebsiteRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBucketWebsite", path: "/{Bucket}?website", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following action is related to DeleteObject:    PutObject
    public func deleteObject(_ input: DeleteObjectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteObjectOutput> {
        return self.client.execute(operation: "DeleteObject", path: "/{Bucket}/{Key+}?x-id=DeleteObject", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Removes the entire tag set from the specified object. For more information about managing object tags, see  Object Tagging.
    ///  To use this operation, you must have permission to perform the s3:DeleteObjectTagging action.
    ///  To delete tags of a specific object version, add the versionId query parameter in the request. You will need permission for the s3:DeleteObjectVersionTagging action.
    ///  The following operations are related to DeleteBucketMetricsConfiguration:    PutObjectTagging     GetObjectTagging
    public func deleteObjectTagging(_ input: DeleteObjectTaggingRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteObjectTaggingOutput> {
        return self.client.execute(operation: "DeleteObjectTagging", path: "/{Bucket}/{Key+}?tagging", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to DeleteObjects:    CreateMultipartUpload     UploadPart     CompleteMultipartUpload     ListParts     AbortMultipartUpload
    public func deleteObjects(_ input: DeleteObjectsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteObjectsOutput> {
        return self.client.execute(operation: "DeleteObjects", path: "/{Bucket}?delete&x-id=DeleteObjects", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Removes the PublicAccessBlock configuration for an Amazon S3 bucket. To use this operation, you must have the s3:PutBucketPublicAccessBlock permission. For more information about permissions, see Permissions Related to Bucket Subresource Operations and Managing Access Permissions to Your Amazon S3 Resources.
    ///  The following operations are related to DeletePublicAccessBlock:    Using Amazon S3 Block Public Access     GetPublicAccessBlock     PutPublicAccessBlock     GetBucketPolicyStatus
    @discardableResult public func deletePublicAccessBlock(_ input: DeletePublicAccessBlockRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeletePublicAccessBlock", path: "/{Bucket}?publicAccessBlock", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketAccelerateConfiguration(_ input: GetBucketAccelerateConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketAccelerateConfigurationOutput> {
        return self.client.execute(operation: "GetBucketAccelerateConfiguration", path: "/{Bucket}?accelerate", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketAcl(_ input: GetBucketAclRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketAclOutput> {
        return self.client.execute(operation: "GetBucketAcl", path: "/{Bucket}?acl", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketAnalyticsConfiguration(_ input: GetBucketAnalyticsConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketAnalyticsConfigurationOutput> {
        return self.client.execute(operation: "GetBucketAnalyticsConfiguration", path: "/{Bucket}?analytics&x-id=GetBucketAnalyticsConfiguration", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Returns the Cross-Origin Resource Sharing (CORS) configuration information set for the bucket.
    ///  To use this operation, you must have permission to perform the s3:GetBucketCORS action. By default, the bucket owner has this permission and can grant it to others.
    ///  For more information about CORS, see  Enabling Cross-Origin Resource Sharing.
    ///  The following operations are related to GetBucketCors:    PutBucketCors     DeleteBucketCors
    public func getBucketCors(_ input: GetBucketCorsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketCorsOutput> {
        return self.client.execute(operation: "GetBucketCors", path: "/{Bucket}?cors", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketEncryption(_ input: GetBucketEncryptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketEncryptionOutput> {
        return self.client.execute(operation: "GetBucketEncryption", path: "/{Bucket}?encryption", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketIntelligentTieringConfiguration(_ input: GetBucketIntelligentTieringConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketIntelligentTieringConfigurationOutput> {
        return self.client.execute(operation: "GetBucketIntelligentTieringConfiguration", path: "/{Bucket}?intelligent-tiering&x-id=GetBucketIntelligentTieringConfiguration", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Returns an inventory configuration (identified by the inventory configuration ID) from the bucket.
    ///  To use this operation, you must have permissions to perform the s3:GetInventoryConfiguration action. The bucket owner has this permission by default and can grant this permission to others. For more information about permissions, see Permissions Related to Bucket Subresource Operations and Managing Access Permissions to Your Amazon S3 Resources.
    ///  For information about the Amazon S3 inventory feature, see Amazon S3 Inventory.
    ///  The following operations are related to GetBucketInventoryConfiguration:    DeleteBucketInventoryConfiguration     ListBucketInventoryConfigurations     PutBucketInventoryConfiguration
    public func getBucketInventoryConfiguration(_ input: GetBucketInventoryConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketInventoryConfigurationOutput> {
        return self.client.execute(operation: "GetBucketInventoryConfiguration", path: "/{Bucket}?inventory&x-id=GetBucketInventoryConfiguration", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketLifecycleConfiguration(_ input: GetBucketLifecycleConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketLifecycleConfigurationOutput> {
        return self.client.execute(operation: "GetBucketLifecycleConfiguration", path: "/{Bucket}?lifecycle", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Returns the Region the bucket resides in. You set the bucket's Region using the LocationConstraint request parameter in a CreateBucket request. For more information, see CreateBucket.
    ///  To use this implementation of the operation, you must be the bucket owner.  To use this API against an access point, provide the alias of the access point in place of the bucket name.
    ///  The following operations are related to GetBucketLocation:    GetObject     CreateBucket
    public func getBucketLocation(_ input: GetBucketLocationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketLocationOutput> {
        return self.client.execute(operation: "GetBucketLocation", path: "/{Bucket}?location", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Returns the logging status of a bucket and the permissions users have to view and modify that status. To use GET, you must be the bucket owner.
    ///  The following operations are related to GetBucketLogging:    CreateBucket     PutBucketLogging
    public func getBucketLogging(_ input: GetBucketLoggingRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketLoggingOutput> {
        return self.client.execute(operation: "GetBucketLogging", path: "/{Bucket}?logging", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Gets a metrics configuration (specified by the metrics configuration ID) from the bucket. Note that this doesn't include the daily storage metrics.
    ///  To use this operation, you must have permissions to perform the s3:GetMetricsConfiguration action. The bucket owner has this permission by default. The bucket owner can grant this permission to others. For more information about permissions, see Permissions Related to Bucket Subresource Operations and Managing Access Permissions to Your Amazon S3 Resources.
    ///  For information about CloudWatch request metrics for Amazon S3, see Monitoring Metrics with Amazon CloudWatch.
    ///  The following operations are related to GetBucketMetricsConfiguration:    PutBucketMetricsConfiguration     DeleteBucketMetricsConfiguration     ListBucketMetricsConfigurations     Monitoring Metrics with Amazon CloudWatch
    public func getBucketMetricsConfiguration(_ input: GetBucketMetricsConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketMetricsConfigurationOutput> {
        return self.client.execute(operation: "GetBucketMetricsConfiguration", path: "/{Bucket}?metrics&x-id=GetBucketMetricsConfiguration", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketNotificationConfiguration(_ input: GetBucketNotificationConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<NotificationConfiguration> {
        return self.client.execute(operation: "GetBucketNotificationConfiguration", path: "/{Bucket}?notification", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketOwnershipControls(_ input: GetBucketOwnershipControlsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketOwnershipControlsOutput> {
        return self.client.execute(operation: "GetBucketOwnershipControls", path: "/{Bucket}?ownershipControls", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following action is related to GetBucketPolicy:    GetObject
    public func getBucketPolicy(_ input: GetBucketPolicyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketPolicyOutput> {
        return self.client.execute(operation: "GetBucketPolicy", path: "/{Bucket}?policy", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Retrieves the policy status for an Amazon S3 bucket, indicating whether the bucket is public. In order to use this operation, you must have the s3:GetBucketPolicyStatus permission. For more information about Amazon S3 permissions, see Specifying Permissions in a Policy.
    ///  For more information about when Amazon S3 considers a bucket public, see The Meaning of "Public".
    ///  The following operations are related to GetBucketPolicyStatus:    Using Amazon S3 Block Public Access     GetPublicAccessBlock     PutPublicAccessBlock     DeletePublicAccessBlock
    public func getBucketPolicyStatus(_ input: GetBucketPolicyStatusRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketPolicyStatusOutput> {
        return self.client.execute(operation: "GetBucketPolicyStatus", path: "/{Bucket}?policyStatus", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Returns the replication configuration of a bucket.  It can take a while to propagate the put or delete a replication configuration to all Amazon S3 systems. Therefore, a get request soon after put or delete can return a wrong result.   For information about replication configuration, see Replication in the Amazon S3 User Guide.
    ...
    ///  The following operations are related to GetBucketReplication:    PutBucketReplication     DeleteBucketReplication
    public func getBucketReplication(_ input: GetBucketReplicationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketReplicationOutput> {
        return self.client.execute(operation: "GetBucketReplication", path: "/{Bucket}?replication", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Returns the request payment configuration of a bucket. To use this version of the operation, you must be the bucket owner. For more information, see Requester Pays Buckets.
    ///  The following operations are related to GetBucketRequestPayment:    ListObjects
    public func getBucketRequestPayment(_ input: GetBucketRequestPaymentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketRequestPaymentOutput> {
        return self.client.execute(operation: "GetBucketRequestPayment", path: "/{Bucket}?requestPayment", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///   GetBucketTagging has the following special error:   Error code: NoSuchTagSet    Description: There is no tag set associated with the bucket.
    ///  The following operations are related to GetBucketTagging:    PutBucketTagging     DeleteBucketTagging
    public func getBucketTagging(_ input: GetBucketTaggingRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketTaggingOutput> {
        return self.client.execute(operation: "GetBucketTagging", path: "/{Bucket}?tagging", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to GetBucketVersioning:    GetObject     PutObject     DeleteObject
    public func getBucketVersioning(_ input: GetBucketVersioningRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketVersioningOutput> {
        return self.client.execute(operation: "GetBucketVersioning", path: "/{Bucket}?versioning", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketWebsite(_ input: GetBucketWebsiteRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBucketWebsiteOutput> {
        return self.client.execute(operation: "GetBucketWebsite", path: "/{Bucket}?website", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///      If you supply a versionId, you need the s3:GetObjectVersion permission to access a specific version of an object. If you request a specific version, you do not need to have the s3:GetObject permission.    If the current version of the object is a delete marker, Amazon S3 behaves as if the object was deleted and includes x-amz-delete-marker: true in the response.
    ...
    ///  The following operations are related to GetObject:    ListBuckets     GetObjectAcl
    public func getObject(_ input: GetObjectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetObjectOutput> {
        return self.client.execute(operation: "GetObject", path: "/{Bucket}/{Key+}?x-id=GetObject", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getObjectAcl(_ input: GetObjectAclRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetObjectAclOutput> {
        return self.client.execute(operation: "GetObjectAcl", path: "/{Bucket}/{Key+}?acl", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following actions are related to GetObjectAttributes:    GetObject     GetObjectAcl     GetObjectLegalHold     GetObjectLockConfiguration     GetObjectRetention     GetObjectTagging     HeadObject     ListParts
    public func getObjectAttributes(_ input: GetObjectAttributesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetObjectAttributesOutput> {
        return self.client.execute(operation: "GetObjectAttributes", path: "/{Bucket}/{Key+}?attributes", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following action is related to GetObjectLegalHold:    GetObjectAttributes
    public func getObjectLegalHold(_ input: GetObjectLegalHoldRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetObjectLegalHoldOutput> {
        return self.client.execute(operation: "GetObjectLegalHold", path: "/{Bucket}/{Key+}?legal-hold", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Gets the Object Lock configuration for a bucket. The rule specified in the Object Lock configuration will be applied by default to every new object placed in the specified bucket. For more information, see Locking Objects.
    ///  The following action is related to GetObjectLockConfiguration:    GetObjectAttributes
    public func getObjectLockConfiguration(_ input: GetObjectLockConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetObjectLockConfigurationOutput> {
        return self.client.execute(operation: "GetObjectLockConfiguration", path: "/{Bucket}?object-lock", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following action is related to GetObjectRetention:    GetObjectAttributes
    public func getObjectRetention(_ input: GetObjectRetentionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetObjectRetentionOutput> {
        return self.client.execute(operation: "GetObjectRetention", path: "/{Bucket}/{Key+}?retention", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following actions are related to GetObjectTagging:    DeleteObjectTagging     GetObjectAttributes     PutObjectTagging
    public func getObjectTagging(_ input: GetObjectTaggingRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetObjectTaggingOutput> {
        return self.client.execute(operation: "GetObjectTagging", path: "/{Bucket}/{Key+}?tagging", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getObjectTorrent(_ input: GetObjectTorrentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetObjectTorrentOutput> {
        return self.client.execute(operation: "GetObjectTorrent", path: "/{Bucket}/{Key+}?torrent", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to GetPublicAccessBlock:    Using Amazon S3 Block Public Access     PutPublicAccessBlock     GetPublicAccessBlock     DeletePublicAccessBlock
    public func getPublicAccessBlock(_ input: GetPublicAccessBlockRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetPublicAccessBlockOutput> {
        return self.client.execute(operation: "GetPublicAccessBlock", path: "/{Bucket}?publicAccessBlock", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func headBucket(_ input: HeadBucketRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "HeadBucket", path: "/{Bucket}", httpMethod: .HEAD, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following actions are related to HeadObject:    GetObject     GetObjectAttributes
    public func headObject(_ input: HeadObjectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<HeadObjectOutput> {
        return self.client.execute(operation: "HeadObject", path: "/{Bucket}/{Key+}", httpMethod: .HEAD, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to ListBucketAnalyticsConfigurations:    GetBucketAnalyticsConfiguration     DeleteBucketAnalyticsConfiguration     PutBucketAnalyticsConfiguration
    public func listBucketAnalyticsConfigurations(_ input: ListBucketAnalyticsConfigurationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListBucketAnalyticsConfigurationsOutput> {
        return self.client.execute(operation: "ListBucketAnalyticsConfigurations", path: "/{Bucket}?analytics&x-id=ListBucketAnalyticsConfigurations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listBucketIntelligentTieringConfigurations(_ input: ListBucketIntelligentTieringConfigurationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListBucketIntelligentTieringConfigurationsOutput> {
        return self.client.execute(operation: "ListBucketIntelligentTieringConfigurations", path: "/{Bucket}?intelligent-tiering&x-id=ListBucketIntelligentTieringConfigurations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  To use this operation, you must have permissions to perform the s3:GetInventoryConfiguration action. The bucket owner has this permission by default. The bucket owner can grant this permission to others. For more information about permissions, see Permissions Related to Bucket Subresource Operations and Managing Access Permissions to Your Amazon S3 Resources.
    ///  For information about the Amazon S3 inventory feature, see Amazon S3 Inventory
    ///  The following operations are related to ListBucketInventoryConfigurations:    GetBucketInventoryConfiguration     DeleteBucketInventoryConfiguration     PutBucketInventoryConfiguration
    public func listBucketInventoryConfigurations(_ input: ListBucketInventoryConfigurationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListBucketInventoryConfigurationsOutput> {
        return self.client.execute(operation: "ListBucketInventoryConfigurations", path: "/{Bucket}?inventory&x-id=ListBucketInventoryConfigurations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to ListBucketMetricsConfigurations:    PutBucketMetricsConfiguration     GetBucketMetricsConfiguration     DeleteBucketMetricsConfiguration
    public func listBucketMetricsConfigurations(_ input: ListBucketMetricsConfigurationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListBucketMetricsConfigurationsOutput> {
        return self.client.execute(operation: "ListBucketMetricsConfigurations", path: "/{Bucket}?metrics&x-id=ListBucketMetricsConfigurations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Returns a list of all buckets owned by the authenticated sender of the request. To use this operation, you must have the s3:ListAllMyBuckets permission.
    public func listBuckets(logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListBucketsOutput> {
        return self.client.execute(operation: "ListBuckets", path: "/", httpMethod: .GET, serviceConfig: self.config, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to ListMultipartUploads:    CreateMultipartUpload     UploadPart     CompleteMultipartUpload     ListParts     AbortMultipartUpload
    public func listMultipartUploads(_ input: ListMultipartUploadsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListMultipartUploadsOutput> {
        return self.client.execute(operation: "ListMultipartUploads", path: "/{Bucket}?uploads", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listObjectVersions(_ input: ListObjectVersionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListObjectVersionsOutput> {
        return self.client.execute(operation: "ListObjectVersions", path: "/{Bucket}?versions", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to ListObjects:    ListObjectsV2     GetObject     PutObject     CreateBucket     ListBuckets
    public func listObjects(_ input: ListObjectsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListObjectsOutput> {
        return self.client.execute(operation: "ListObjects", path: "/{Bucket}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listObjectsV2(_ input: ListObjectsV2Request, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListObjectsV2Output> {
        return self.client.execute(operation: "ListObjectsV2", path: "/{Bucket}?list-type=2", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listParts(_ input: ListPartsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListPartsOutput> {
        return self.client.execute(operation: "ListParts", path: "/{Bucket}/{Key+}?x-id=ListParts", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Sets the accelerate configuration of an existing bucket. Amazon S3 Transfer Acceleration is a bucket-level feature that enables you to perform faster data transfers to Amazon S3.
    ///  To use this operation, you must have permission to perform the s3:PutAccelerateConfiguration action. The bucket owner has this permission by default. The bucket owner can grant this permission to others. For more information about permissions, see Permissions Related to Bucket Subresource Operations and Managing Access Permissions to Your Amazon S3 Resources.
    ///  The Transfer Acceleration state of a bucket can be set to one of the following two values:   Enabled – Enables accelerated data transfers to the bucket.   Suspended – Disables accelerated data transfers to the bucket.
    ///  The GetBucketAccelerateConfiguration action returns the transfer acceleration state of a bucket.
    ///  After setting the Transfer Acceleration state of a bucket to Enabled, it might take up to thirty minutes before the data transfer rates to the bucket increase.
    ///  The name of the bucket used for Transfer Acceleration must be DNS-compliant and must not contain periods (".").
    ///  For more information about transfer acceleration, see Transfer Acceleration.
    ///  The following operations are related to PutBucketAccelerateConfiguration:    GetBucketAccelerateConfiguration     CreateBucket
    @discardableResult public func putBucketAccelerateConfiguration(_ input: PutBucketAccelerateConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketAccelerateConfiguration", path: "/{Bucket}?accelerate", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  You can use one of the following two ways to set a bucket's permissions:   Specify the ACL in the request body   Specify permissions using request headers
    ...
    ///
    ///   Related Resources     GetBucketAnalyticsConfiguration     DeleteBucketAnalyticsConfiguration     ListBucketAnalyticsConfigurations
    @discardableResult public func putBucketAnalyticsConfiguration(_ input: PutBucketAnalyticsConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketAnalyticsConfiguration", path: "/{Bucket}?analytics", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func putBucketCors(_ input: PutBucketCorsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketCors", path: "/{Bucket}?cors", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func putBucketEncryption(_ input: PutBucketEncryptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketEncryption", path: "/{Bucket}?encryption", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func putBucketIntelligentTieringConfiguration(_ input: PutBucketIntelligentTieringConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketIntelligentTieringConfiguration", path: "/{Bucket}?intelligent-tiering", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func putBucketInventoryConfiguration(_ input: PutBucketInventoryConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketInventoryConfiguration", path: "/{Bucket}?inventory", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following are related to PutBucketLifecycleConfiguration:    Examples of Lifecycle Configuration     GetBucketLifecycleConfiguration     DeleteBucketLifecycle
    @discardableResult public func putBucketLifecycleConfiguration(_ input: PutBucketLifecycleConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketLifecycleConfiguration", path: "/{Bucket}?lifecycle", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Set the logging parameters for a bucket and to specify permissions for who can view and modify the logging parameters. All logs are saved to buckets in the same Amazon Web Services Region as the source bucket. To set the logging status of a bucket, you must be the bucket owner.
    ///  The bucket owner is automatically granted FULL_CONTROL to all logs. You use the Grantee request element to grant access to other people. The Permissions request element specifies the kind of access the grantee has to the logs.  If the target bucket for log delivery uses the bucket owner enforced setting for S3 Object Ownership, you can't use the Grantee request element to grant access to others. Permissions can only be granted using policies. For more information, see Permissions for server access log delivery in the Amazon S3 User Guide.
    ...
    ///  The following operations are related to PutBucketLogging:    PutObject     DeleteBucket     CreateBucket     GetBucketLogging
    @discardableResult public func putBucketLogging(_ input: PutBucketLoggingRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketLogging", path: "/{Bucket}?logging", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Sets a metrics configuration (specified by the metrics configuration ID) for the bucket. You can have up to 1,000 metrics configurations per bucket. If you're updating an existing metrics configuration, note that this is a full replacement of the existing metrics configuration. If you don't include the elements you want to keep, they are erased.
    ///  To use this operation, you must have permissions to perform the s3:PutMetricsConfiguration action. The bucket owner has this permission by default. The bucket owner can grant this permission to others. For more information about permissions, see Permissions Related to Bucket Subresource Operations and Managing Access Permissions to Your Amazon S3 Resources.
    ///  For information about CloudWatch request metrics for Amazon S3, see Monitoring Metrics with Amazon CloudWatch.
    ///  The following operations are related to PutBucketMetricsConfiguration:    DeleteBucketMetricsConfiguration     GetBucketMetricsConfiguration     ListBucketMetricsConfigurations
    ///   GetBucketLifecycle has the following special error:   Error code: TooManyConfigurations    Description: You are attempting to create a new configuration but have already reached the 1,000-configuration limit.   HTTP Status Code: HTTP 400 Bad Request
    @discardableResult public func putBucketMetricsConfiguration(_ input: PutBucketMetricsConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketMetricsConfiguration", path: "/{Bucket}?metrics", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following action is related to PutBucketNotificationConfiguration:    GetBucketNotificationConfiguration
    @discardableResult public func putBucketNotificationConfiguration(_ input: PutBucketNotificationConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketNotificationConfiguration", path: "/{Bucket}?notification", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Creates or modifies OwnershipControls for an Amazon S3 bucket. To use this operation, you must have the s3:PutBucketOwnershipControls permission. For more information about Amazon S3 permissions, see Specifying permissions in a policy.  For information about Amazon S3 Object Ownership, see Using object ownership.  The following operations are related to PutBucketOwnershipControls:    GetBucketOwnershipControls     DeleteBucketOwnershipControls
    @discardableResult public func putBucketOwnershipControls(_ input: PutBucketOwnershipControlsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketOwnershipControls", path: "/{Bucket}?ownershipControls", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///   As a security precaution, the root user of the Amazon Web Services account that owns a bucket can always use this operation, even if the policy explicitly denies the root user the ability to perform this action.   For more information, see Bucket policy examples.
    ...
    @discardableResult public func putBucketPolicy(_ input: PutBucketPolicyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketPolicy", path: "/{Bucket}?policy", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to PutBucketReplication:    GetBucketReplication     DeleteBucketReplication
    @discardableResult public func putBucketReplication(_ input: PutBucketReplicationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketReplication", path: "/{Bucket}?replication", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Sets the request payment configuration for a bucket. By default, the bucket owner pays for downloads from the bucket. This configuration parameter enables the bucket owner (only) to specify that the person requesting the download will be charged for the download. For more information, see Requester Pays Buckets.
    ///  The following operations are related to PutBucketRequestPayment:    CreateBucket     GetBucketRequestPayment
    @discardableResult public func putBucketRequestPayment(_ input: PutBucketRequestPaymentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketRequestPayment", path: "/{Bucket}?requestPayment", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  The following operations are related to PutBucketTagging:    GetBucketTagging     DeleteBucketTagging
    @discardableResult public func putBucketTagging(_ input: PutBucketTaggingRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketTagging", path: "/{Bucket}?tagging", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Sets the versioning state of an existing bucket. You can set the versioning state with one of the following values:
    ...
    ///   Related Resources     CreateBucket     DeleteBucket     GetBucketVersioning
    @discardableResult public func putBucketVersioning(_ input: PutBucketVersioningRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketVersioning", path: "/{Bucket}?versioning", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///  To redirect all website requests sent to the bucket's website endpoint, you add a website configuration with the following elements. Because all requests are sent to another website, you don't need to provide index document name for the bucket.    WebsiteConfiguration     RedirectAllRequestsTo     HostName     Protocol
    ...
    @discardableResult public func putBucketWebsite(_ input: PutBucketWebsiteRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutBucketWebsite", path: "/{Bucket}?website", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putObject(_ input: PutObjectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutObjectOutput> {
        return self.client.execute(operation: "PutObject", path: "/{Bucket}/{Key+}?x-id=PutObject", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putObjectAcl(_ input: PutObjectAclRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutObjectAclOutput> {
        return self.client.execute(operation: "PutObjectAcl", path: "/{Bucket}/{Key+}?acl", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putObjectLegalHold(_ input: PutObjectLegalHoldRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutObjectLegalHoldOutput> {
        return self.client.execute(operation: "PutObjectLegalHold", path: "/{Bucket}/{Key+}?legal-hold", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putObjectLockConfiguration(_ input: PutObjectLockConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutObjectLockConfigurationOutput> {
        return self.client.execute(operation: "PutObjectLockConfiguration", path: "/{Bucket}?object-lock", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putObjectRetention(_ input: PutObjectRetentionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutObjectRetentionOutput> {
        return self.client.execute(operation: "PutObjectRetention", path: "/{Bucket}/{Key+}?retention", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Sets the supplied tag-set to an object that already exists in a bucket. A tag is a key-value pair. You can associate tags with an object by sending a PUT request against the tagging subresource that is associated with the object. You can retrieve tags by sending a GET request. For more information, see GetObjectTagging.
    ...
    public func putObjectTagging(_ input: PutObjectTaggingRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutObjectTaggingOutput> {
        return self.client.execute(operation: "PutObjectTagging", path: "/{Bucket}/{Key+}?tagging", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Creates or modifies the PublicAccessBlock configuration for an Amazon S3 bucket. To use this operation, you must have the s3:PutBucketPublicAccessBlock permission. For more information about Amazon S3 permissions, see Specifying Permissions in a Policy.
    ///   When Amazon S3 evaluates the PublicAccessBlock configuration for a bucket or an object, it checks the PublicAccessBlock configuration for both the bucket (or the bucket that contains the object) and the bucket owner's account. If the PublicAccessBlock configurations are different between the bucket and the account, Amazon S3 uses the most restrictive combination of the bucket-level and account-level settings.
    ///  For more information about when Amazon S3 considers a bucket or an object public, see The Meaning of "Public".
    ///   Related Resources     GetPublicAccessBlock     DeletePublicAccessBlock     GetBucketPolicyStatus     Using Amazon S3 Block Public Access
    @discardableResult public func putPublicAccessBlock(_ input: PutPublicAccessBlockRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutPublicAccessBlock", path: "/{Bucket}?publicAccessBlock", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func restoreObject(_ input: RestoreObjectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreObjectOutput> {
        return self.client.execute(operation: "RestoreObject", path: "/{Bucket}/{Key+}?restore&x-id=RestoreObject", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///    GetObject Support  The SelectObjectContent action does not support the following GetObject functionality. For more information, see GetObject.    Range: Although you can specify a scan range for an Amazon S3 Select request (see SelectObjectContentRequest - ScanRange in the request parameters), you cannot specify the range of bytes of an object to return.    GLACIER, DEEP_ARCHIVE and REDUCED_REDUNDANCY storage classes: You cannot specify the GLACIER, DEEP_ARCHIVE, or REDUCED_REDUNDANCY storage classes. For more information, about storage classes see Storage Classes in the Amazon S3 User Guide.     Special Errors
    ///  For a list of special errors for this operation, see List of SELECT Object Content Error Codes   Related Resources     GetObject     GetBucketLifecycleConfiguration     PutBucketLifecycleConfiguration
    public func selectObjectContent(_ input: SelectObjectContentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SelectObjectContentOutput> {
        return self.client.execute(operation: "SelectObjectContent", path: "/{Bucket}/{Key+}?select&select-type=2&x-id=SelectObjectContent", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Uploads a part in a multipart upload.  In this operation, you provide part data in your request. However, you have an option to specify your existing Amazon S3 object as a data source for the part you are uploading. To upload a part from an existing object, you use the UploadPartCopy operation.
    ...
    ///  For more information on multipart uploads, go to Multipart Upload Overview in the Amazon S3 User Guide . For information on the permissions required to use the multipart upload API, go to Multipart Upload and Permissions in the Amazon S3 User Guide.
    ...
    ///   Special Errors       Code: NoSuchUpload     Cause: The specified multipart upload does not exist. The upload ID might be invalid, or the multipart upload might have been aborted or completed.     HTTP Status Code: 404 Not Found      SOAP Fault Code Prefix: Client
    ///
    ///   Related Resources     CreateMultipartUpload     CompleteMultipartUpload     AbortMultipartUpload     ListParts     ListMultipartUploads
    public func uploadPart(_ input: UploadPartRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UploadPartOutput> {
        return self.client.execute(operation: "UploadPart", path: "/{Bucket}/{Key+}?x-id=UploadPart", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Uploads a part by copying data from an existing object as data source. You specify the data source by adding the request header x-amz-copy-source in your request and a byte range by adding the request header x-amz-copy-source-range in your request.  For information about maximum and minimum part sizes and other multipart upload specifications, see Multipart upload limits in the Amazon S3 User Guide.   Instead of using an existing object as part data, you might use the UploadPart action and provide data in your request.
    ///  You must initiate a multipart upload before you can upload any part. In response to your initiate request. Amazon S3 returns a unique identifier, the upload ID, that you must include in your upload part request. For more information about using the UploadPartCopy operation, see the following:
    ...
    ///   Special Errors       Code: NoSuchUpload     Cause: The specified multipart upload does not exist. The upload ID might be invalid, or the multipart upload might have been aborted or completed.     HTTP Status Code: 404 Not Found         Code: InvalidRequest     Cause: The specified copy source is not supported as a byte-range copy source.     HTTP Status Code: 400 Bad Request
    ///
    ///   Related Resources     CreateMultipartUpload     UploadPart     CompleteMultipartUpload     AbortMultipartUpload     ListParts     ListMultipartUploads
    public func uploadPartCopy(_ input: UploadPartCopyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UploadPartCopyOutput> {
        return self.client.execute(operation: "UploadPartCopy", path: "/{Bucket}/{Key+}?x-id=UploadPartCopy", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func writeGetObjectResponse(_ input: WriteGetObjectResponseRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "WriteGetObjectResponse", path: "/WriteGetObjectResponse?x-id=WriteGetObjectResponse", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "{RequestRoute}.", logger: logger, on: eventLoop)
    }
    ...
    ///  For more information about conditional requests, see RFC 7232.
    ///  The following operations are related to GetObject:    ListBuckets     GetObjectAcl
    public func getObjectStreaming(_ input: GetObjectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil, _ stream: @escaping (ByteBuffer, EventLoop) -> EventLoopFuture<Void>) -> EventLoopFuture<GetObjectOutput> {
        return self.client.execute(operation: "GetObject", path: "/{Bucket}/{Key+}?x-id=GetObject", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop, stream: stream)
    }

    /// Returns torrent files from a bucket. BitTorrent can save you bandwidth when you're distributing large files. For more information about BitTorrent, see Using BitTorrent with Amazon S3.  You can get torrent only for objects that are less than 5 GB in size, and that are not encrypted using server-side encryption with a customer-provided encryption key.  To use GET, you must have READ access to the object.  This action is not supported by Amazon S3 on Outposts. The following action is related to GetObjectTorrent:    GetObject
    public func getObjectTorrentStreaming(_ input: GetObjectTorrentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil, _ stream: @escaping (ByteBuffer, EventLoop) -> EventLoopFuture<Void>) -> EventLoopFuture<GetObjectTorrentOutput> {
        return self.client.execute(operation: "GetObjectTorrent", path: "/{Bucket}/{Key+}?torrent", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop, stream: stream)
    }
}
