...
extension SecurityLake {
    ...
    public struct CreateSubscriberRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.subscriberDescription, name: "subscriberDescription", parent: name, pattern: "^[\\\\\\w\\-_:/.@=+]*$")
        }
    ...
    public struct UpdateSubscriberRequest: AWSEncodableShape {
        ...
        public init(externalId: String? = nil, id: String, sourceTypes: [SourceType]? = nil, subscriberDescription: String? = nil, subscriberName: String? = nil) {
            self.externalId = externalId
            self.id = id
            self.sourceTypes = sourceTypes
            self.subscriberDescription = subscriberDescription
