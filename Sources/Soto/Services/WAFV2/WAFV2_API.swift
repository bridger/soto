...
public struct WAFV2: AWSService {
    ...
    public init(
        ...
        self.config = AWSServiceConfig(
            ...
            serviceEndpoints: [
                ...
                "fips-af-south-1": "wafv2-fips.af-south-1.amazonaws.com",
                "fips-ap-east-1": "wafv2-fips.ap-east-1.amazonaws.com",
                "fips-ap-northeast-1": "wafv2-fips.ap-northeast-1.amazonaws.com",
                "fips-ap-northeast-2": "wafv2-fips.ap-northeast-2.amazonaws.com",
                "fips-ap-northeast-3": "wafv2-fips.ap-northeast-3.amazonaws.com",
                "fips-ap-south-1": "wafv2-fips.ap-south-1.amazonaws.com",
                "fips-ap-southeast-1": "wafv2-fips.ap-southeast-1.amazonaws.com",
                "fips-ap-southeast-2": "wafv2-fips.ap-southeast-2.amazonaws.com",
                "fips-ap-southeast-3": "wafv2-fips.ap-southeast-3.amazonaws.com",
                "fips-ca-central-1": "wafv2-fips.ca-central-1.amazonaws.com",
                "fips-cn-north-1": "wafv2-fips.cn-north-1.amazonaws.com.cn",
                "fips-cn-northwest-1": "wafv2-fips.cn-northwest-1.amazonaws.com.cn",
                "fips-eu-central-1": "wafv2-fips.eu-central-1.amazonaws.com",
                "fips-eu-north-1": "wafv2-fips.eu-north-1.amazonaws.com",
                "fips-eu-south-1": "wafv2-fips.eu-south-1.amazonaws.com",
                "fips-eu-west-1": "wafv2-fips.eu-west-1.amazonaws.com",
                "fips-eu-west-2": "wafv2-fips.eu-west-2.amazonaws.com",
                "fips-eu-west-3": "wafv2-fips.eu-west-3.amazonaws.com",
                "fips-me-south-1": "wafv2-fips.me-south-1.amazonaws.com",
                "fips-sa-east-1": "wafv2-fips.sa-east-1.amazonaws.com",
                "fips-us-east-1": "wafv2-fips.us-east-1.amazonaws.com",
                "fips-us-east-2": "wafv2-fips.us-east-2.amazonaws.com",
                "fips-us-gov-east-1": "wafv2-fips.us-gov-east-1.amazonaws.com",
                "fips-us-gov-west-1": "wafv2-fips.us-gov-west-1.amazonaws.com",
                "fips-us-west-1": "wafv2-fips.us-west-1.amazonaws.com",
                "fips-us-west-2": "wafv2-fips.us-west-2.amazonaws.com",
    ...
    public func generateMobileSdkReleaseUrl(_ input: GenerateMobileSdkReleaseUrlRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GenerateMobileSdkReleaseUrlResponse> {
        return self.client.execute(operation: "GenerateMobileSdkReleaseUrl", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getManagedRuleSet(_ input: GetManagedRuleSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetManagedRuleSetResponse> {
        return self.client.execute(operation: "GetManagedRuleSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// WAF client application integration in the WAF Developer Guide.
    public func getMobileSdkRelease(_ input: GetMobileSdkReleaseRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMobileSdkReleaseResponse> {
        return self.client.execute(operation: "GetMobileSdkRelease", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listAvailableManagedRuleGroupVersions(_ input: ListAvailableManagedRuleGroupVersionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAvailableManagedRuleGroupVersionsResponse> {
        return self.client.execute(operation: "ListAvailableManagedRuleGroupVersions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listManagedRuleSets(_ input: ListManagedRuleSetsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListManagedRuleSetsResponse> {
        return self.client.execute(operation: "ListManagedRuleSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// WAF client application integration in the WAF Developer Guide.
    public func listMobileSdkReleases(_ input: ListMobileSdkReleasesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListMobileSdkReleasesResponse> {
        return self.client.execute(operation: "ListMobileSdkReleases", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putManagedRuleSetVersions(_ input: PutManagedRuleSetVersionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutManagedRuleSetVersionsResponse> {
        return self.client.execute(operation: "PutManagedRuleSetVersions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateManagedRuleSetVersionExpiryDate(_ input: UpdateManagedRuleSetVersionExpiryDateRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateManagedRuleSetVersionExpiryDateResponse> {
        return self.client.execute(operation: "UpdateManagedRuleSetVersionExpiryDate", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
